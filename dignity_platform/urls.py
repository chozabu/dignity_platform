...
urlpatterns = [
    ...
    url(r'^people/(?P<person_id>[0-9]+)/remove_service/(?P<service_id>[0-9]+)/$', views.remove_service,
        name='remove_service'),
    url(r'^people/(?P<person_id>[0-9]+)/remove_support/(?P<support_id>[0-9]+)/$', views.remove_support,
        name='remove_support'),
